...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('representatives_address', 'name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'Address.name'
        db.delete_column('representatives_address', 'name')
