...
rep_names = {
    ...
    u"Alain MoyneBressand": [u"Alain", u"Moyne-Bressand"],
    u"Bernard Gerard": [u"Bernard", u"Gérard"],
    u"Françoise Guegot": [u"Françoise", u"Guégot"],
    u"Gisèle Biemouret": [u"Gisèle", u"Biémouret"],
    u"Jean-François Cope": [u"Jean-François", u"Copé"],
    u"Jean-Yves Le Le Bouillonnec": [u"Jean-Yves", u"Le Bouillonnec"],
    u"Jean-Yves Le Le Deaut": [u"Jean-Yves", u"Le Déaut"],
    u"Laure de La La Raudiere": [u"Laure", u"de La Raudière"],
    u"Marc Joulaud": [u"Marc", u"JOULAUD"],
    u"Marc Le Le Fur": [u"Marc", u"Le Fur"],
    u"Nicolas DupontAignan": [u"Nicolas", u"Dupont-Aignan"],
    u"Patrice MartinLalande": [u"Patrice", u"Martin-Lalande"],
    u"Patrice Verchere": [u"Patrice", u"Verchère"],
    u"Sauveur GandolfiScheit": [u"Sauveur", u"Gandolfi-Scheit"],
}
